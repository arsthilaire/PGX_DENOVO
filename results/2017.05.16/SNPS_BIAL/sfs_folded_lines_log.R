...
for(p in 1:5){
	...
	if(p==1){ plot(hist$density, type='l',cex=0.7, col= color[p], ylab="Frequency", xlab= "Frequency class",xaxt="n" , log="xy", main= "Site Frequency Spectrum for each superpopulation\nof the 1000G data for the selected CYPgenes" ) }
