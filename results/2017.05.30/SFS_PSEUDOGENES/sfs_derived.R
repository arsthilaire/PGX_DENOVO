pdf('sfs_derived_pseudogenes.pdf')
...
x<-barplot(result,beside=TRUE, col= color, ylab="Compte",legend = rownames(result), xlab= "Fréquence allélique", main= "Spectre des fréquences alléliques pour chaque superpopulation\n du 1000 Genomes Project des pseudogènes du Cytochrome P450",las = 2,  cex.names=0.6)
